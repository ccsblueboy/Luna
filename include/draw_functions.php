...
<?php } ?>
	<div class="btn-toolbar btn-toolbar-top">
		...
		<div class="btn-group">
			<a class="btn btn-default btn-editor" href="javascript:void(0);" onclick="AddTag('inline','b');" title="<?php _e('Bold', 'luna'); ?>" tabindex="-1"><span class="fa fa-bold fa-fw"></span></a>
			<a class="btn btn-default btn-editor" href="javascript:void(0);" onclick="AddTag('inline','u');" title="<?php _e('Underline', 'luna'); ?>" tabindex="-1"><span class="fa fa-underline fa-fw"></span></a>
			<a class="btn btn-default btn-editor hidden-sm hidden-xs" href="javascript:void(0);" onclick="AddTag('inline','i');" title="<?php _e('Italic', 'luna'); ?>" tabindex="-1"><span class="fa fa-italic fa-fw"></span></a>
			<a class="btn btn-default btn-editor hidden-md hidden-sm hidden-xs" href="javascript:void(0);" onclick="AddTag('inline','s');" title="<?php _e('Strike', 'luna'); ?>" tabindex="-1"><span class="fa fa-strikethrough fa-fw"></span></a>
		</div>
		<div class="btn-group">
			...
			<a class="btn btn-default btn-editor hidden-md hidden-sm hidden-xs" href="javascript:void(0);" onclick="AddTag('inline','sub');" title="<?php _e('Subscript', 'luna'); ?>" tabindex="-1"><span class="fa fa-subscript fa-fw"></span></a>
			<a class="btn btn-default btn-editor hidden-md hidden-sm hidden-xs" href="javascript:void(0);" onclick="AddTag('inline','sup');" title="<?php _e('Superscript', 'luna'); ?>" tabindex="-1"><span class="fa fa-superscript fa-fw"></span></a>
		</div>
		<div class="btn-group">
			<a class="btn btn-default btn-editor" href="javascript:void(0);" onclick="AddTag('inline','quote');" title="<?php _e('Quote', 'luna'); ?>" tabindex="-1"><span class="fa fa-quote-left fa-fw"></span></a>
			<a class="btn btn-default btn-editor hidden-sm hidden-xs" href="javascript:void(0);" onclick="AddTag('code','code');" title="<?php _e('Code', 'luna'); ?>" tabindex="-1"><span class="fa fa-code fa-fw"></span></a>
		...
		<div class="btn-group">
			<a class="btn btn-default btn-editor" href="javascript:void(0);" onclick="AddTag('list', 'list');" title="<?php _e('List', 'luna'); ?>" tabindex="-1"><span class="fa fa-list-ul fa-fw"></span></a>
			<a class="btn btn-default btn-editor" href="javascript:void(0);" onclick="AddTag('inline','*');" title="<?php _e('List item', 'luna'); ?>" tabindex="-1"><span class="fa fa-asterisk fa-fw"></span></a>
		</div>
	...
	<div class="btn-toolbar btn-toolbar-top">
		<div class="btn-group">
            ...
            <?php endif; ?>
			<a class="btn btn-default btn-editor" href="javascript:void(0);" onclick="AddTag('inline','i');" title="<?php _e('ins', 'luna'); ?>" tabindex="-1"><span class="fa fa-i-cursor fa-fw"></span></a>
		</div>
		<div class="btn-group">
		...
		<div class="btn-group">
			<a class="btn btn-default btn-editor" href="javascript:void(0);" onclick="AddTag('spoiler','spoiler');" title="<?php _e('Color', 'luna'); ?>" tabindex="-1"><span class="fa fa-eye-slash fa-fw"></span></a>
		</div>
        <?php endif; ?>
    </div>
    <?php endif; ?>
